    ...
    <el-row :gutter="10" class="elContainerFooter">
        <el-col :lg="7" :xl="7" class="elContent">
            ...
            <el-row class="elLBgd" :style="{'padding': contentHeight * 0.05 + 'px'}">
                ...
                <el-col class="elRowContent" :lg='24' :xl="24" :style="{'max-height': centerChartHeight * 0.72 +'px'}">
                    <el-row class="elBorder" v-for="(item,index) in attractionsList" :key="index">
        ...
        <el-col :lg="10" :xl="10" class="elContent">
            <el-row>
                <el-col :lg='12' :xl="12">
                    ...
                    <el-row class="elCtBgd">
                        <el-col :lg='24' :xl="24" class="chartFontSizeStyle">
                            <pie-charts :id="hotelRestNumId" :restNumData="data3" :hotelNumData="data1"
                ...
                <el-col :lg='12' :xl="12">
                    <!--标题-->
                    <el-row type="flex" justify="start" align="middle" class="elBgd"
                            :style="{'padding': contentHeight * 0.05 + 'px'}">
                        <el-col :lg='3' :xl="3">
                            <img class="elImage" :width="contentHeight * 0.15 + 'px'"
                                 src="../../../assets/screenImage/pieIcon.png">
                    ...
                    <el-row class="elCtBgd">
                        <el-col :lg='24' :xl="24" class="chartFontSizeStyle">
                            <pies-chart :id="hotelRestScoreId" :hotelScoreData="data2" :restScoreData="data4"
                                        :height="centerChartHeight * 0.95 + 'px'">
                                <span class="one">酒店</span>
                                <span>餐饮</span>
                            </pies-chart>
        ...
        <el-col :lg="7" :xl="7" class="elContent">
            ...
            <el-row class="elRBgd">
                ...
                <el-col class="elRowContent" :lg='24' :xl="24" :style="{'max-height': centerChartHeight * 0.85 +'px'}">
        ...
        methods: {
            ...
            getSpotRankFun: function () {
                getSpotRank().then(res => {
                    if (res.code === 0) {
                        //获取Top5的数据
                        this.attractionsList = res.qdhlist ? res.qdhlist.slice(0, maxDataNum) : [];
                    } else {
            ...
            getHotelRankFun: function () {
                getHotelRank().then(res => {
                    if (res.code === 0 && res.data) {
                        //获取Top5的数据
                        this.hotelList = res.data.goodList ? res.data.goodList.slice(0, maxDataNum) : [];
                    } else {
                        this.$message.error(res.message);
                    }
                });
            ...
            toViewHotelDetail(item) {
                const url = this.$config.detailUrl + '/hotelsingleshow/?hotelname=' + item._id + '&hotelrate=' + item.shopRate + '&currpage=1&token=' + getToken();
                window.open(url);
            }
        },
        watch: {
