<template>
    <div class="foot">
        ...
        <div style="margin: 10px;display: flex;align-items: center">
            <img src="../../../assets/DetailsImgs/commentIcon.png" style="width: 15px;height: 15px; margin-right:15px;">
            <span class="chartTitle" style="font-size: 18px;">酒店评论</span>
        </div>
        <el-tabs v-model="featureWord" @tab-click="tabChange">
            ...
            <el-tab-pane :label="tabsList[2]" name="server"></el-tab-pane>
            <el-tab-pane :label="tabsList[3]" name="price"></el-tab-pane>
        </el-tabs>
        <el-button :type = "goodType" @click="selectGood">
          {{goodStr}}</el-button>
...
<script>
    import { getShopComment } from "@/api/restaurant";
        ...
        methods: {
         ...
         //选择好评和差评
            ...
            changeComment: function(currPage) {
                    this.commentList = [];
                if(currPage * 5 <= this.keywordComments.length)
                    var ends = currPage * 5;
                else
                    ends = this.keywordComments.length;
